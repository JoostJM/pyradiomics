...
paramsFile = os.path.abspath(r'exampleSettings\VoxelParams.yaml')
...
extractor = voxelextractor.RadiomicsVoxelExtractor(paramsFile)
...
for featureName in featureVector:
  resultsName = '%s_%s.nrrd' % (testcase, featureName)
  sitk.WriteImage(featureVector[featureName], resultsName)
  print("Computed %s, written to %s" % (featureName, resultsName))
